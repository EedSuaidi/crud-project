        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" name="thn_masuk" class="form-control" placeholder="Tahun Masuk">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Tahun Keluar</strong>
                    <input type="number" name="thn_keluar" class="form-control" placeholder="Tahun Keluar">
                </div>
            </div>
